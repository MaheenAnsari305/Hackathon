...
const rooms = [
  ...
  { roomNumber: '102', roomType: 'Double', price: 150, status: 'Occupied', image: 'https://media.istockphoto.com/id/1390233984/photo/modern-luxury-bedroom.jpg?s=612x612&w=0&k=20&c=po91poqYoQTbHUpO1LD1HcxCFZVpRG-loAMWZT7YRe4=' },
  ...
  { roomNumber: '104', roomType: 'Suite', price: 250, status: 'Available', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQFhGQd1lnDokX8rl_VXEgALX9nBDre-dQVrQ&s' },
  ...
  { roomNumber: '111', roomType: 'Double', price: 160, status: 'Occupied', image: 'https://2.imimg.com/data2/SI/TS/MY-3125576/lemon_tree_hotel_single-room-500x500.jpg' },
  ...
  { roomNumber: '113', roomType: 'Double', price: 190, status: 'Available', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS6y-biBVMMN6Fw-SQKGrueD9LrKcnGC6uunA&s' },
  ...
  { roomNumber: '115', roomType: 'Single', price: 140, status: 'Occupied', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQmT0SdqjxIiDws_F9LWUfVPwZGCVWelUY0_Q&s' },
  ];
...
const RoomAvailable = () => {
  ...
  const handleBooking = (roomNumber) => {
    const loggedInCustomerID = 'C123'; // Static customerID for now, should be dynamic in a real app
